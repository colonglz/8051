...
//altsyncram ADDRESS_ACLR_A="NONE" CLOCK_ENABLE_INPUT_A="BYPASS" CLOCK_ENABLE_OUTPUT_A="BYPASS" DEVICE_FAMILY="Cyclone IV E" ENABLE_RUNTIME_MOD="YES" INIT_FILE="oc8051_altera_rom_mif.mif" INSTANCE_NAME="ROM1" NUMWORDS_A=4096 OPERATION_MODE="ROM" OUTDATA_ACLR_A="NONE" OUTDATA_REG_A="UNREGISTERED" WIDTH_A=8 WIDTH_BYTEENA_A=1 WIDTHAD_A=12 address_a clock0 q_a
...
module  oc8051_altera_rom1_altsyncram1
	( 
	address_a,
	address_b,
	clock0,
...
`endif
	...
	assign
		...
		wren_a = 1'b0;
endmodule //oc8051_altera_rom1_altsyncram1

//synthesis_resources = M9K 4 sld_mod_ram_rom 1 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  oc8051_altera_rom1_altsyncram
	( 
	address_a,
	clock0,
...
`endif
	...
	oc8051_altera_rom1_altsyncram1   altsyncram1
	( 
	.address_a(address_a),
	...
	assign
		q_a = wire_altsyncram1_q_a;
endmodule //oc8051_altera_rom1_altsyncram
//VALID FILE
...
`endif
	...
	oc8051_altera_rom1_altsyncram	oc8051_altera_rom1_altsyncram_component (
				.address_a (address),
				.clock0 (clock),
				.q_a (sub_wire0));
