...
module fft (
	...
	auk_dspip_r22sdf_top_fft_130	auk_dspip_r22sdf_top_fft_130_inst(
		.clk(clk),
		.reset_n(reset_n),
		.fftpts_in(fftpts_in),
		.inverse(inverse),
	...
	defparam
		auk_dspip_r22sdf_top_fft_130_inst.MAX_FFTPTS_g = 1024,
		auk_dspip_r22sdf_top_fft_130_inst.NUM_STAGES_g = 5,
		auk_dspip_r22sdf_top_fft_130_inst.DATAWIDTH_g = 12,
		auk_dspip_r22sdf_top_fft_130_inst.TWIDWIDTH_g = 16,
		auk_dspip_r22sdf_top_fft_130_inst.MAX_GROW_g = 11,
		auk_dspip_r22sdf_top_fft_130_inst.TWIDROM_BASE_g = "fft_",
		auk_dspip_r22sdf_top_fft_130_inst.DSP_ROUNDING_g = 0,
		auk_dspip_r22sdf_top_fft_130_inst.INPUT_FORMAT_g = "NATURAL_ORDER",
		auk_dspip_r22sdf_top_fft_130_inst.OUTPUT_FORMAT_g = "NATURAL_ORDER",
		auk_dspip_r22sdf_top_fft_130_inst.REPRESENTATION_g = "FIXEDPT",
		auk_dspip_r22sdf_top_fft_130_inst.DSP_ARCH_g = 0,
		auk_dspip_r22sdf_top_fft_130_inst.PRUNE_g = "0,0,0,0,0";
endmodule
...
// Retrieval info:      <PRIVATE name = "NUM_LE" value="6139"  type="INTEGER"  enable="1" />
...
// Retrieval info:      <PRIVATE name = "NUM_MEMBITS" value="84004"  type="INTEGER"  enable="1" />
