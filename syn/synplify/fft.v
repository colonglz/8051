...
module fft (
	...
	asj_fft_si_se_so_bb_fft_130	asj_fft_si_se_so_bb_fft_130_inst(
		.clk(clk),
		.reset_n(reset_n),
		.inverse(inverse),
	...
	defparam
		asj_fft_si_se_so_bb_fft_130_inst.nps = 1024,
		asj_fft_si_se_so_bb_fft_130_inst.bfp = 1,
		asj_fft_si_se_so_bb_fft_130_inst.nume = 1,
		asj_fft_si_se_so_bb_fft_130_inst.mpr = 12,
		asj_fft_si_se_so_bb_fft_130_inst.twr = 8,
		asj_fft_si_se_so_bb_fft_130_inst.bpr = 16,
		asj_fft_si_se_so_bb_fft_130_inst.bpb = 4,
		asj_fft_si_se_so_bb_fft_130_inst.fpr = 4,
		asj_fft_si_se_so_bb_fft_130_inst.mram = 0,
		asj_fft_si_se_so_bb_fft_130_inst.m512 = 0,
		asj_fft_si_se_so_bb_fft_130_inst.mult_type = 1,
		asj_fft_si_se_so_bb_fft_130_inst.mult_imp = 0,
		asj_fft_si_se_so_bb_fft_130_inst.dsp_arch = 0,
		asj_fft_si_se_so_bb_fft_130_inst.srr = "AUTO_SHIFT_REGISTER_RECOGNITION=OFF",
		asj_fft_si_se_so_bb_fft_130_inst.rfs1 = "fft_1n1024sin.hex",
		asj_fft_si_se_so_bb_fft_130_inst.rfs2 = "fft_2n1024sin.hex",
		asj_fft_si_se_so_bb_fft_130_inst.rfs3 = "fft_3n1024sin.hex",
		asj_fft_si_se_so_bb_fft_130_inst.rfc1 = "fft_1n1024cos.hex",
		asj_fft_si_se_so_bb_fft_130_inst.rfc2 = "fft_2n1024cos.hex",
		asj_fft_si_se_so_bb_fft_130_inst.rfc3 = "fft_3n1024cos.hex";
endmodule
...
// Retrieval info:  <NETLIST_SECTION class="altera.ipbu.flowbase.netlist.model.FFTModelClass"  active_core="asj_fft_si_se_so_bb_fft_130" >
...
// Retrieval info:      <PRIVATE name = "NUM_LE" value="3202"  type="INTEGER"  enable="1" />
// Retrieval info:      <PRIVATE name = "NUM_M4K" value="15"  type="INTEGER"  enable="1" />
...
// Retrieval info:      <PRIVATE name = "DIRECTION" value="2"  type="INTEGER"  enable="1" />
